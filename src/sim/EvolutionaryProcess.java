...
public abstract class EvolutionaryProcess extends Thread{
	...
	protected int optimalSinksNumber;
	...
	public EvolutionaryProcess(Parameters parameters) {
		this.parameters = parameters;
		parameters.setProcess(this);
		generation = 0;
		...
		optimalSinksNumber = parameters.INITIAL_SINK_NUMBER;
		folderPath = "";
	...
	abstract public void startFromAndPause(AbstractSimulationState state);
	...
	public int getOptimalSinksNumber() {
		return optimalSinksNumber;
	}

	public void setOptimalSinksNumber(int optimalSinksNumber) {
		this.optimalSinksNumber = optimalSinksNumber;
	}
