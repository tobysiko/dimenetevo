 ...
 *
 */
public class VertexElement extends SparseVertex implements Element, Serializable {
	 ...
	 */
	public VertexElement(Network net, Parameters p) {
		this.net = net;
		...
		vectorIndex = net.getIndexOf(this);
	}
...
//	}
	...
	/* (non-Javadoc)
	 * @see sim.datatype.Element#getDimerTimeRemaining()
	 */
	...
	/* (non-Javadoc)
	 * @see sim.datatype.Element#setDimerTimeRemaining(int)
	 */
